...
(function () {
  ...
  async function showRestoreSessionList() {
    ...
    setTimeout(() => {
      ...
      if (importBtn) {
        ...
        importBtn.addEventListener('click', () => {
          const importUrl = browserDetector.getApi().runtime.getURL('interface/import/import.html');
          browserDetector.getApi().tabs.create({ url: importUrl });
        });
      }
    ...
    sessionsList.setAttribute('tabindex', '0');
